...
.EXAMPLE
PS C:\> .\Disable-CorporateNews.ps1 -TargetSiteUrl "https://intranet.mydomain.com/sites/targetSite"
.EXAMPLE
PS C:\> $creds = Get-Credential
PS C:\> .\Disable-CorporateNews.ps1 -TargetSiteUrl "https://intranet.mydomain.com/sites/targetSite" -Credentials $creds
#>
[CmdletBinding()]
param
(
...
Write-Host -ForegroundColor White "|              Disabling Corporate News                 |"
Write-Host -ForegroundColor White "--------------------------------------------------------"
...
try
{
	...
	foreach($file in $files){
		if ($file.Name -like "*corporatenews*")
		{
    ...
    Write-Host -ForegroundColor Green "Corporate News removal succeded"
}
catch
{
